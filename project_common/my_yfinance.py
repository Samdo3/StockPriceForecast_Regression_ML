...
def predict_stock_price3(ticker):
    ...
    close_price = result.get("Predicted Close", 0)
    prediction = result.get("Prediction", "UNKNOWN")
    max_diff = result.get("Max_diff", 0)
    min_diff = result.get("Min_diff", 0)
    ...
    return data_display, img, isUp, open_price, close_price, prediction, max_diff, min_diff